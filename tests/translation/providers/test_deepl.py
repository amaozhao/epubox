...
class TestDeepLProvider:
    """Test cases for DeepL translation provider."""
    ...
    @pytest.mark.asyncio
    async def test_translate_rate_limit(self, provider):
    ...
    @pytest.mark.asyncio
    async def test_translate_too_many_requests(self, provider):
    ...
    @pytest.mark.asyncio
    async def test_translate_http_error(self, provider):
    ...
    @pytest.mark.asyncio
    async def test_helper_functions(self, provider):
