...
class TestGroqProvider:
    """Test cases for Groq translation provider."""
    ...
    @pytest.mark.asyncio
    async def test_translate_with_html_and_placeholders(self, provider):
    ...
    @pytest.mark.asyncio
    async def test_translate_mock(self, provider):
        """Test translation with mocked API response."""
        test_text = "Hello world"
        mock_response = AsyncMock()
        mock_response.choices = [
            MagicMock(message=MagicMock(content="Bonjour le monde"))
        ]
