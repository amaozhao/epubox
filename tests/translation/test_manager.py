...
class TestTranslationManager:
    ...
    @pytest.fixture
    async def provider_model(self, db_session):
    ...
    @pytest.fixture
    async def translation_manager(self, db_session, provider_model):
    ...
    async def test_manager_initialization(self, db_session, translation_manager):
    ...
    async def test_translate_with_default_provider(self, translation_manager):
    ...
    async def test_translate_with_specific_provider(
        self, db_session, translation_manager, provider_model
    ):
    ...
    async def test_translation_error_handling(self, translation_manager):
    ...
    async def test_provider_not_found(self, translation_manager):
    ...
    async def test_no_default_provider(self, db_session):
