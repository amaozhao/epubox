...
class TestTranslationModels:
    ...
    @pytest.mark.asyncio
    async def test_create_provider(self, db_session: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_stats(self, db_session: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_provider_stats_relationship(self, db_session: AsyncSession):
        ...
        stmt = (
            ...
            .options(
                selectinload(TranslationProvider.stats).selectinload(
    ...
    @pytest.mark.asyncio
    async def test_limit_type_enum(self):
    ...
    def test_provider_model_validation(self):
    ...
    def test_provider_model_config_types(self):
