...
class TestProviderFactory:
    ...
    def mock_configs(self):
        ...
        return {
            "mock": {
                "module": "tests.translation.test_factory",
                "class": "MockProvider",
            }
        }

    @pytest.fixture
    def provider_factory(self, mock_configs):
    ...
    def test_load_provider_class(self, provider_factory, mock_configs):
    ...
    def test_load_provider_class_invalid_type(self, provider_factory):
    ...
    def test_load_provider_class_invalid_module(self, provider_factory, mock_configs):
    ...
    def test_get_provider_class(self, provider_factory):
    ...
    def test_create_provider(self, provider_factory, provider_model):
